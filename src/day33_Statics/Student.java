...
1. Create a class called Student
     ...
     Add a constructor that allows user to create object by setting the name and gender of student
     Add a constructor that allows user to create object by setting the name  and studentID of student
     Add a constructor that allows user to create object by setting the name of student
     Add a constructor that allows user to create object by setting the name of student
     Add a constructor that allows user to create object by setting the name of student
