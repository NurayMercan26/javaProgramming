...
public class UnaryOperators {
    ...
    public static void main(String[] args) {
        ...
        int a = 5;
        ++a; // increment: increases the value by 1 right away
        ...
        System.out.println(++b); // pre increment: increasse the value by 1 right away
        ...
        System.out.println(--x);// pre decrement: deccreases the value by 1 right away
