...
public class arithmeticOperators {
    ...
    public static void main(String[] args) {
        ...
        int division = num1 / num2; //division variable cantains the result of num1 divided num2
        int remainder = num1%num2; // ramainder variable contains the remainder of divided by number
