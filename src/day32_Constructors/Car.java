...
class name: Car
    instance variables:
      make, model, year, price, color
       ...
       1 st constructor: initializes the make only
       2 nd constructor: initializes make&model
       ...
       4th constructor: initializes make,model, year
       MUST use constructor call to set the make, model,year)
       5th Constructor: intializes all the instances
       MUST use constructor call to set the make, model,year,price,color)
