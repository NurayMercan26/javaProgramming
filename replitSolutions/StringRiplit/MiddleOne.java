...
public class MiddleOne {
    public static void main(String[] args) {
        ...
        if (word.length() == 1) {
            System.out.println((Character.toString(word.charAt(0))) + (Character.toString(word.charAt(0))) +
                    (Character.toString(word.charAt(0))));
        } else if (word.length() == 2){
            System.out.println((Character.toString(word.charAt(0))) +
                    (Character.toString(word.charAt(1))) +
                    (Character.toString(word.charAt(0))+(Character.toString(word.charAt(1)))));
            ...
            System.out.println(Character.toString(word.charAt(word.length()/2-1))+(Character.toString(word.charAt(word.length()/2))));
        }
