...
public class BiggestNumberin2DArray {
    public static void main(String[] args) {
        ...
        /*
        find max numbers  of each 1D arrays and store them inside 1D array
         */
        int []biggestNumbers = new int[arr2D_1.length];//
        for (int i = 0; i <arr2D_1.length ; i++) {
            //System.out.println("arr2D_1 = " + Arrays.toString(arr2D_1[i]));====>I am printing 1Darrays
            int max = arr2D_1[i][0];//assume that each 1 D arrays first element is max number
